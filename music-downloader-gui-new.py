...
class MusicDownloaderGUI:
    ...
    def _download_single_thread(self, song_name: str) -> None:
        """单曲下载线程"""
        try:
    ...
    def _download_batch_thread(self, file_path: str, quality: Optional[int], lyrics_option: str) -> None:
        """批量下载线程"""
        try:
            download_from_file(
                file_path,
